...
#define DLT_MSIN_MSTP 0x0eU /**< message type */
#define DLT_MSIN_MTIN 0xf0U /**< message type info */

#define DLT_MSIN_MSTP_SHIFT 1U /**< shift right offset to get mstp value */
#define DLT_MSIN_MTIN_SHIFT 4U /**< shift right offset to get mtin value */
 ...
 */
#define DLT_TYPE_LOG 0x00U /**< Log message type */
#define DLT_TYPE_APP_TRACE 0x01U /**< Application trace message type */
#define DLT_TYPE_NW_TRACE 0x02U /**< Network trace message type */
#define DLT_TYPE_CONTROL 0x03U /**< Control message type */

/*
 * Definitions of msti parameter in extended header.
 */
#define DLT_TRACE_VARIABLE 0x01U /**< tracing of a variable */
#define DLT_TRACE_FUNCTION_IN 0x02U /**< tracing of function calls */
#define DLT_TRACE_FUNCTION_OUT 0x03U /**< tracing of function return values */
#define DLT_TRACE_STATE 0x04U /**< tracing of states of a state machine */
#define DLT_TRACE_VFB 0x05U /**< tracing of virtual function bus */
 ...
 */
#define DLT_CONTROL_REQUEST 0x01U /**< Request message */
...
#define DLT_TYPE_INFO_TYLE \
  0x0000000fU /**< Length of standard data: 1 = 8bit, 2 = 16bit, 3 = 32 bit, 4 = 64 bit, 5 = 128 bit */
 ...
 */
#define DLT_SERVICE_ID_CALLSW_CINJECTION 0xFFFU
...
enum dlt_services {
  ...
  DLT_SERVICE_ID_SET_COM_INTERFACE_STATUS = 0x07U,
  DLT_SERVICE_ID_SET_COM_INTERFACE_MAX_BANDWIDTH = 0x08U,
  DLT_SERVICE_ID_SET_VERBOSE_MODE = 0x09U,
  DLT_SERVICE_ID_SET_MESSAGE_FILTERING = 0x0AU,
  DLT_SERVICE_ID_SET_TIMING_PACKETS = 0x0BU,
  DLT_SERVICE_ID_GET_LOCAL_TIME = 0x0CU,
  DLT_SERVICE_ID_USE_ECU_ID = 0x0DU,
  DLT_SERVICE_ID_USE_SESSION_ID = 0x0EU,
  DLT_SERVICE_ID_USE_TIMESTAMP = 0x0FU,
  DLT_SERVICE_ID_USE_EXTENDED_HEADER = 0x10U,
  ...
  DLT_SERVICE_ID_MESSAGE_BUFFER_OVERFLOW = 0x14U,
